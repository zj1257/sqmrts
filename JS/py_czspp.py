...
class Spider(Spider):  # 元类 默认的元类 type
    ...
    def homeVideoContent(self):
        # https://czzy03.com
        # https://www.czzzu.com
        rsp = self.fetch("https://czzy03.com")
    ...
    def categoryContent(self, tid, pg, filter, extend):
        result = {}
        url = 'https://czzy03.com/{0}/page/{1}'.format(tid, pg)
        rsp = self.fetch(url)
        root = self.html(self.cleanText(rsp.text))
    ...
    def detailContent(self, array):
        tid = array[0]
        url = 'https://czzy03.com/movie/{0}.html'.format(tid)
        rsp = self.fetch(url)
        root = self.html(self.cleanText(rsp.text))
    ...
    def searchContent(self, key, quick):
        url = 'https://czzy03.com/?s={0}'.format(key)
    ...
    def playerContent(self, flag, id, vipFlags):
        url = 'https://czzy03.com/v_play/{0}.html'.format(id)
